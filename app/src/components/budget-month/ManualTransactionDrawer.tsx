...
import { useCreateManualTransaction } from "../../hooks/budget-month";
...
export default function ManualTransactionDrawer({
  open,
  onClose,
  budgetMonthId,
  onSuccess,
  ...
  const [createManualTransaction, { loading }] = useCreateManualTransaction();
